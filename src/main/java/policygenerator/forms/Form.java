            ...
            if (fe.isValid()) {
                ...
                switch (elementType) {
                    ...
                    case BOOLEAN:
                        ...
                        break;
                    case INTEGER:
                        if (((IntegerInput) fe).getValue() == null && settings.isUseSafeDefaults()) {
                            model.put(fe.getId(), 0);
                        } else {
                            model.put(fe.getId(), ((IntegerInput) fe).getValue());
                        }
                        break;
                    case DOUBLE:
                        if (((DoubleInput) fe).getValue() == null && settings.isUseSafeDefaults()) {
                            model.put(fe.getId(), 0);
                        } else {
                        ...
                        break;
                    case DATE:
                        if (((DateInput) fe).getValue() == null && settings.isUseSafeDefaults()) {
                            model.put(fe.getId(), new Date(0));
                        } else {
                            model.put(fe.getId(), ((DateInput) fe).getValue());
                        }
                        break;
                    case SELECTONE:
                        if (((SelectOne) fe).getValue() == null && settings.isUseSafeDefaults()) {
                            model.put(fe.getId(), "");
                        } else {
